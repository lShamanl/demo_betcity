...
use App\Profile\Application\Betcity\UseCase\Remove\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_profile_betcity_remove';
     ...
     * @OA\Response(
     *     response=200,
     *     description="Remove command for Client",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/profile/betcities/remove.{_format}',
        name: self::NAME,
