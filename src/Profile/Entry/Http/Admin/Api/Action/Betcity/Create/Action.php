...
use App\Profile\Application\Betcity\UseCase\Create\Handler;
...
class Action
{
    public const NAME = 'api_admin_app_profile_betcity_create';
     ...
     * @OA\Response(
     *     response=201,
     *     description="Create command for Client",
     *     @OA\JsonContent(
     *         allOf={
     ...
     */
    #[Route(
        path: '/api/admin/profile/betcities/create.{_format}',
        name: self::NAME,
